function [F_new, constraint_error, DF_mat, iteration_counter] = pAC_mS_sC_y0xd0Fixed(error_tol, iterMax, n_Nodes, F_new, dynamicsWithSTM, options, prms, familyIndex, stepSize, nullVecDF, ds_PO, y0, xd0)
%%% Description
...
while ((constraint_error > error_tol) && (iteration_counter < iterMax)) 
    ...
    % --------------------------
    [DF_mat, constraints] = multShooter_stateContinuity_y0xd0Fixed(n_Nodes, F_new, dynamicsWithSTM, options, prms, y0, xd0);
