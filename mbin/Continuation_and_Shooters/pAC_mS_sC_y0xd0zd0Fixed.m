function [F_new, constraint_error, DF_mat, iteration_counter] = pAC_mS_sC_y0xd0zd0Fixed(error_tol, iterMax, n_Nodes, F_new, dynamicsWithSTM, options, prms, familyIndex, stepSize, nullVecDF, ds_PO, y0, xd0, zd0)
%%% Description
...
%       y0              - [1x1] Value for y0 of first node
%       xd0             - [1x1] Value for xd0 of first node
%       zd0             - [1x1] Value for zd0 of first node
% ------------------------------------------------------------------------
%%% Outputs
...
while ((constraint_error > error_tol) && (iteration_counter < iterMax)) 
    ...
    % --------------------------
    [DF_mat, constraints] = multShooter_stateContinuity_y0xd0zd0Fixed(n_Nodes, F_new, dynamicsWithSTM, options, prms, y0, xd0, zd0);
