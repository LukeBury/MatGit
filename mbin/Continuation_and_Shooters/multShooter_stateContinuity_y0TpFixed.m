function [DF_mat, constraints_vec] = multShooter_stateContinuity_y0TpFixed(n_Nodes, F, dynamicsWithSTM, options, prms, y0, Tp_des)
%%% Description
...
parfor node_i = 1:n_Nodes
    ...
    %%% Integrate node            
    if node_i == 1
        [~, X_node] = ode113(dynamicsWithSTM, [0, Tp_des/n_Nodes], [F(1); y0; F(2:5); stm0_colVec], options, prms);
    else
