function [DF_mat, constraints_vec] = multShooter_stateContinuity_xFixed_LyapPO(n_Nodes, x0, F, dynamicsWithSTM, options, prms)
%%% Description
%       Multiple shooter for state continuity of a 6-d state (ex, [x; y; z;
%       xd; yd; zd]). Initial x-guess is fixed and won't change. Only yd is
%       free in initial state. All other elements besides x are zero
%       
% ------------------------------------------------------------------------
%%% Inputs
