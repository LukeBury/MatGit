function [A] = get_Amat_CR3BP(mu, r_n)
%%% Description
...
A(4,5) = 2;
A(5,4) = -2;
A(4,1) = (mu - 1)/((mu + x_n)^2 + y_n^2 + z_n^2)^(3/2) - mu/((mu + x_n - 1)^2 + y_n^2 + z_n^2)^(3/2) + (3*mu*(2*mu + 2*x_n - 2)*(mu + x_n - 1))/(2*((mu + x_n - 1)^2 + y_n^2 + z_n^2)^(5/2)) - (3*(2*mu + 2*x_n)*(mu + x_n)*(mu - 1))/(2*((mu + x_n)^2 + y_n^2 + z_n^2)^(5/2)) + 1;
...
A(5,2) = (mu - 1)/((mu + x_n)^2 + y_n^2 + z_n^2)^(3/2) + y_n*((3*mu*y_n)/((mu + x_n - 1)^2 + y_n^2 + z_n^2)^(5/2) - (3*y_n*(mu - 1))/((mu + x_n)^2 + y_n^2 + z_n^2)^(5/2)) - mu/((mu + x_n - 1)^2 + y_n^2 + z_n^2)^(3/2) + 1;
