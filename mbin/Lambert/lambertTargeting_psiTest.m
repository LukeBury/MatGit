...
figure (11); hold all
PlotBoi2('$\Psi$, $rad^2$','TOF, $days$',16,'LaTex')
% ylim([0 4000])
plot([0, 0], [0, 5500],'k--','linewidth',2)
plot([4*pi^2 4*pi^2], [0, 5500],'k--','linewidth',2)
...
if nRevs == 0 % If no complete revolutions
    ...
    plot(psi_test,tof_test./86400,'b','linewidth',2)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    plot(psi_test,tof_test./86400,'r','linewidth',2)
