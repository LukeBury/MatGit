...
% red, lt blue, blue (good for progression)
colors.sch.d3_3 = [247, 37, 133; 76, 201, 240; 8, 61, 119]./255; 
...
colors.sch.d5_1 = [255, 190, 11; 251, 86, 7; 255, 0, 110; 131, 56, 236; 58, 134, 255]./255;


%%% 80s color scheme
colors.sch.eighties.blue       = [57,  104, 203]./255;
colors.sch.eighties.purple     = [202, 124, 216]./255;
colors.sch.eighties.cyan       = [16,  231, 226]./255;
colors.sch.eighties.pink       = [255, 104, 168]./255;
colors.sch.eighties.yellow     = [249, 235, 15]./255;
colors.sch.eighties.red        = [255, 33,  83]./255;
colors.sch.eighties.paleYellow = [255, 254, 206]./255; % Good as a background with the others
%%%-------------------------------------
