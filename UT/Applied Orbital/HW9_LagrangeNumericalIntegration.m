function HW9_LagrangeNumericalIntegration
...
m=384400-384400*cosd(60);
Rsm=[m, -384400*sind(60), 0]; %km - vector from satellite to moon

Res=[norm(Rem)*cosd(60), norm(Rem)*sind(60), 0]; %km - vector from earth to satellite
Ves=[0,0,0]; %km/s
...
[T,V]=ode45(@EOMIntegrator,[t0:15:tf],[Res,Rsm,Ves],options,GMe,GMm,Rem,w);
...
function [ dY ] = EOMIntegrator(t,Y,GMe,GMm,Rem,w)
dY = zeros(9,1);
