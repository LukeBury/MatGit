...
dadN = [8.11e-05;1.04e-04;1.79e-04;2.72e-04;4.31e-04;1.14e-03;4.17e-03;4.17e-03];
figure
hold all
plot(dkk(1:end-1),dadN(1:end-1),'-o','linewidth',2,'markersize',7)
PlotBoi('Stress Intensity Factor, dK','da/dN')

ppp=polyfit(log(dkk(1:end-1)),log(dadN(1:end-1)),1);
m = ppp(1); 
c = exp(ppp(2));
x = [1.15e04:2.1e04];
plot(x,c.*(x.^m))
