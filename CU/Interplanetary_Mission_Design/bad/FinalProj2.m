...
tof_resonance_day = 2*year_Earth_day; % 2 years
...
JD_Departures_VGA_vec = JD_Arrivals_VGA_vec;
JD_Arrivals_EGA1_vec  = linspace(JD_Departures_VGA_vec(end)+1, JD_Departures_VGA_vec(end)+1000, nPoints);
...
% https://cuboulder.zoom.us/j/845093619
