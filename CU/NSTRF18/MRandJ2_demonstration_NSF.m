...
% Setting colors
% cols = colors.sch.s3_1; % Blue
cols = [1 1 1;1 1 1;1 1 1].*0.4; % Grayscale
...
sys{2}.u = jupiter.europa;       % MR, 2.5e-05
sys{2}.a = 671100;
sys{2}.w = 2*pi/(3.551181*86400);
sys{2}.j2 = 0.01475;
sys{2}.Prad = 69911; % km
sys{2}.Srad = 1560;
sys{2}.Srad_n = sys{2}.Srad/sys{2}.a;
sys{2}.tag = 'Europa, MR ~ 3e-05';
sys{2}.moon = 'Europa';
sys{2}.ub1ub2 = [1.898e27,4.799e22].*6.67408e-20;

sys{3}.u = saturn.enceladus;     % MR, 1.9e-07
sys{3}.a = 237948;
sys{3}.w = 2*pi/(1.370218 * 86400);
sys{3}.j2 = 0.01645;
sys{3}.Prad = 58232; % km
sys{3}.Srad = 252;
sys{3}.Srad_n = sys{3}.Srad/sys{3}.a;
sys{3}.tag = 'Enceladus, MR ~ 2e-07';
sys{3}.moon = 'Enceladus';
sys{3}.ub1ub2 = [5.683e26,1.08e20].*6.67408e-20;
...
%         position_BCR = position_BCR + startPos_n;
        ...
        % Plotting L1/L2
        plot((sys{ss}.L1L2)+rS_BCR_n(1), [0,0], '+','markersize',9,'linewidth',2.5,'MarkerEdgeColor',[1,1,1].*0.0, 'MarkerFaceColor', [1,1,1].*0.8);

        
    end
    % Plot Formatting
    if ss == 1
        PlotBoi2('x, normalized','y, normalized',10)
    elseif ss == 2
        PlotBoi2('x, normalized','',10)
    elseif ss == 3
        PlotBoi2('x, normalized','',10)
    end
