...
%         vsc_BCR_n = R3([0,.05,0],angles(kk))./vNorm; % const real velocity
        ...
        %%% Propagating the State
        [Times_n,States_BCR_n] = ode45(@Int_CR3Bn,time,X0_n,options,sys{ss}.u,sys{ss}.Srad_n);
%         [Times_n,States_BCR_n] = ode45(@Int_CR3Bn,time,X0_n,options,sys{ss}.u,rP_BCR_n,rS_BCR_n,sys{ss}.Srad_n);
