...
PO_0 = [1.0225912289857870,-0.0000000000000000,0.0073773112852538,0.0000000000024649,-0.0215167265789516,0.0000000000008407,3.1091762770147824];
...
elseif step_by_Tp_withZFixed
    Tps = linspace(PO_0(7), 1.38, n_Solutions);
...
if savePOs 
    ...
    fileAlreadyExists = 1;
    fileVersion       = 0;
    famName_new       = [famName,'.CR3BP.L2_SHalo_new'];
...
if saveOtherHalos
    ...
    family1_path = [savePath, 'Saturn_Enceladus.CR3BP.L1_SHalo.txt'];
    ...
    fileAlreadyExists   = 1;
    fileVersion         = 0;
    newHaloFileName_new = ['Saturn_Enceladus.CR3BP.L1_NHalo_new'];
    while fileAlreadyExists == 1
...
%     end
    for kk = dataStart:dataStop
        fprintf(newHalofile,'%1.16f,%1.16f,%1.16f,%1.16f,%1.16f,%1.16f,%1.16f,%1.10f,%1.3f\n',...
            family1_data(kk,1), family1_data(kk,2), -family1_data(kk,3), family1_data(kk,4), family1_data(kk,5), -family1_data(kk,6),...
            family1_data(kk,7), family1_data(kk,8), family1_data(kk,9));
