...
if use_C22s
    %%% Create the potential corresponding to the C22s term
    newTerm_C22s = (mu/r2)*(((3*R2n*R2n*C22s)/(r2^2))*(((x-1+mu)^2-y^2)/((x-1+mu)^2+y^2))*(1 - z*z/(r2^2)));
    
    %%% Append new term to the secondary potential
    Vs = Vs + simplify(newTerm_C22s);
end
...
% ========================================================================
%%% Starting process over to solve for mean motion terms
% ========================================================================
% -------------------------------------------------
