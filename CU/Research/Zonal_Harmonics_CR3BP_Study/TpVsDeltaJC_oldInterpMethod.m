...
%     TpRange_SatEnc_SHalo = linspace(minTp_SatEnc_SHalo, maxTp_SatEnc_SHalo, nInterpPoints);
    TpRange_JupEur_Lyap  = linspace(3.09, 5.51,  nInterpPoints);
    TpRange_JupEur_Vert  = linspace(3.22, 6.18,  nInterpPoints);
    TpRange_JupEur_SHalo = linspace(1.81, 3.114, nInterpPoints);
    TpRange_SatEnc_Lyap  = linspace(3.11, 4.29,  nInterpPoints);
    TpRange_SatEnc_Vert  = linspace(3.24, 6.0,  nInterpPoints);
    TpRange_SatEnc_SHalo = linspace(2.30, 3.089, nInterpPoints);
