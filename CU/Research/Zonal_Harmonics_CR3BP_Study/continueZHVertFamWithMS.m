...
% PO_0 = PO_ICs.Jupiter_Europa.CR3BP_J2pJ4pJ6pJ2s.L2_Vertical;
PO_0 = [1.0203688056420148,0.0000000000000045,0.0000000000000000,0.0000000000000023,-0.0000753175472855,0.0046133745651334,3.1820664516233350];
...
elseif step_by_Tp
    Tps = linspace(PO_0(7), 6.18, n_Solutions);
%     Tps = [PO_0(7), 4.35];
end
% ========================================================================
%%% Continue family
...
%     solutionIndex = solutionIndex + 1;
    ...
    while (c_norm > error_tol) && (iter < maxIter)
        ...
        elseif step_by_Tp
%             [DF, constraints_vec] = multShooter_stateContinuity_TpFixed(N_nodes, F_vec, @Int_CR3BnSTM_J2pJ4pJ6pJ2s, options, prms, Tp);
...
if savePOs 
    ...
    fileAlreadyExists = 1;
    fileVersion       = 0;
    famName_new       = [famName,'.CR3BP_J2pJ4pJ6pJ2s.L2_Vertical'];
