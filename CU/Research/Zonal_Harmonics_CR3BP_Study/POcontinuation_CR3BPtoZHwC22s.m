...
%%% First step (in case you're restarting from some point)
step1 = 1;
% step1 = 29; 989
% -------------------------------------------------
...
% % PO_L2_L_1T_4P2_1P3__ns1 
% PO_IC = [0.9831916400446440;
%  0.0000000000000000;
%  -0.0131282883062513;
%  0.0000000000000000;
%  0.0349348518195761;
...
% % PO_L2_L_1T_4P2_1P3__ns2 
% PO_IC = [0.9828179111434627;
%  0.0000000000000000;
%  -0.0141515651995302;
%  0.0000000000000000;
%  0.0299207531685869;
...
if step1 == 1
    ...
    prms.pertScale = perturbationScale_vec(step1-1);
...
for step_i = step1:n_steps
    ...
    if shooter_allFree
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize);
    elseif shooter_y0Fixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_y0Fixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(2));
    elseif shooter_y0xd0Fixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_y0xd0Fixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(2), PO_guess(4));
    elseif shooter_y0zd0Fixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_y0zd0Fixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(2), PO_guess(6));
    elseif shooter_y0xd0zd0Fixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_y0xd0zd0Fixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(2), PO_guess(4), PO_guess(6));
    elseif shooter_z0Fixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_z0Fixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize);
    elseif shooter_zd0Fixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_zd0Fixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize);
    elseif shooter_TpFixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_TpFixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(7));
    elseif shooter_y0TpFixed
        [PO_result, counter, constraint_error] = correctPO_multShooter_stateContinuity_y0TpFixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(2), PO_guess(7));
    elseif shooter_y0xd0TpFixed
        [PO_result, counter, constraint_error] = correctPO_mS_sC_y0xd0TpFixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(2), PO_guess(4), PO_guess(7));
    elseif shooter_y0xd0zd0TpFixed
        [PO_result, counter, constraint_error] = correctPO_mS_sC_y0xd0zd0TpFixed(PO_guess, n_Nodes, @Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, options, prms, error_tol, ms_iterMax, stepSize, PO_guess(2), PO_guess(4), PO_guess(6), PO_guess(7));
    end
    warning('on')
    
    %%% Calculate propagation error
    [T_result, X_result] = ode113(@Int_CR3BnSTM_J2pJ4pJ6pJ2s_C22s_scaled, [0, PO_result(7)], [PO_result(1:6); stm0_colVec], options, prms);
