...
A_L1(1,4) = 1; A_L1(2,5) = 1; A_L1(3,6) = 1; A_L1(4,5) = 2; A_L1(5,4) = -2;

A_L1(4,1) = (v - 1)/((v + x_L1)^2 + y_L1^2 + z_L1^2)^(3/2) - v/((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(3/2) + (3*v*(2*v + 2*x_L1 - 2)^2)/(4*((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2)) - (3*(2*v + 2*x_L1)^2*(v - 1))/(4*((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2)) + 1;
A_L1(4,2) = (3*v*y_L1*(2*v + 2*x_L1 - 2))/(2*((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2)) - (3*y_L1*(2*v + 2*x_L1)*(v - 1))/(2*((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2));
A_L1(4,3) = (3*v*z_L1*(2*v + 2*x_L1 - 2))/(2*((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2)) - (3*z_L1*(2*v + 2*x_L1)*(v - 1))/(2*((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2));
A_L1(5,1) = (3*v*y_L1*(2*v + 2*x_L1 - 2))/(2*((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2)) - (3*y_L1*(2*v + 2*x_L1)*(v - 1))/(2*((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2));
A_L1(5,2) = (v - 1)/((v + x_L1)^2 + y_L1^2 + z_L1^2)^(3/2) - v/((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(3/2) - (3*y_L1^2*(v - 1))/((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2) + (3*v*y_L1^2)/((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2) + 1;
A_L1(5,3) = (3*v*y_L1*z_L1)/((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2) - (3*y_L1*z_L1*(v - 1))/((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2);
A_L1(6,1) = (3*v*z_L1*(2*v + 2*x_L1 - 2))/(2*((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2)) - (3*z_L1*(2*v + 2*x_L1)*(v - 1))/(2*((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2));
A_L1(6,2) = (3*v*y_L1*z_L1)/((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2) - (3*y_L1*z_L1*(v - 1))/((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2);
A_L1(6,3) = (v - 1)/((v + x_L1)^2 + y_L1^2 + z_L1^2)^(3/2) - v/((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(3/2) - (3*z_L1^2*(v - 1))/((v + x_L1)^2 + y_L1^2 + z_L1^2)^(5/2) + (3*v*z_L1^2)/((v + x_L1 - 1)^2 + y_L1^2 + z_L1^2)^(5/2);

[Evecs, Evals] = eig(A_L1);

% Compute First Periodic Orbit (need to perturb L1 point in the direction
% of a center manifold. Evecs 3 and 4 work, but 5 and 6 dont)
X_tilda = [x_L1; y_L1; 0; 0; 0; 0] + 1e-4*real(Evecs(:,3));
...
for k = 1:50
    ...
    if mod(k,10) == 0 && k >= 20
        ...
        xlabel('x [-]')
        ylabel('y [-]')
        legend('Earth','Moon','L_1','Lyapunov Orbits','location','best')
        title('L1 Planar Lyapunov Orbits')
        axis('square')
