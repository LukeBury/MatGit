...
for dJC_vel_mps = linspace(25,75,5) % Enceladus
% for dJC_vel_mps = [50, 62.5, 75, 87.5, 100] %%% For looping whole thing over v0
...
if saveFigs == 1
    ...
    figName = sprintf('%s%sL%1d_v0_%1.2f.png', figPath, secondary.name(1:3), Lpoint, dJC_vel_mps);
    saveas(gcf,figName)
    close all
end
