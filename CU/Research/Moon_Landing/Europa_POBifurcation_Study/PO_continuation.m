...
%         if run_y0TpFixed || run_y0xd0zd0TpFixed
        if run_y0TpFixed || run_y0xd0zd0TpFixed || run_y0xd0TpFixed
            fprintf('PO_i = %1d ... iterations: %1.3d ... actual error = %1.2e ... impact flag = %1d ... minimum altitude ~ %1.1fkm ... Elapsed time: %1.1f seconds\n',...
                PO_i, counter, actualErrors(PO_i+1), impactFlags(PO_i+1), rough_min_alt, toc(ticWhole))
        else
            fprintf('PO_i = %1d ... iterations: %1.3d ... ds_PO = %1.2e ... actual error = %1.2e ... impact flag = %1d... minimum altitude ~ %1.1fkm ... Elapsed time: %1.1f seconds\n',...
                PO_i, counter, ds_PO, actualErrors(PO_i+1), impactFlags(PO_i+1), rough_min_alt, toc(ticWhole))
        end
