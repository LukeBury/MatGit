...
% ------------------------------------
figure; hold all
plot3(X1_BCRn(:,1),X1_BCRn(:,2),X1_BCRn(:,3),'linewidth',1.3,'color',col1)
plot3(X2_BCRn(:,1),X2_BCRn(:,2),X2_BCRn(:,3),'linewidth',1.3,'color',col2)
plot3(X3_BCRn(:,1),X3_BCRn(:,2),X3_BCRn(:,3),'linewidth',1.3,'color',col3)
plot3(X4_BCRn(:,1),X4_BCRn(:,2),X4_BCRn(:,3),'linewidth',1.3,'color',col4)
plot3(X5_BCRn(:,1),X5_BCRn(:,2),X5_BCRn(:,3),'linewidth',1.3,'color',col5)
...
figure; hold all 
plot(time0, JCs_X1,'linewidth',2,'color',col1)
plot(time0, JCs_X2,'linewidth',2,'color',col2)
plot(time0, JCs_X3,'linewidth',2,'color',col3)
plot(time0, JCs_X4,'linewidth',2,'color',col4)
plot(time0, JCs_X5,'linewidth',2,'color',col5)

PlotBoi2('Time, normalized','Jacobi Constants',18,'LaTex')


figure
subplot(5,1,1)
plot(time0, percentchange(JCs_X1),'linewidth',2,'color',col1)
PlotBoi2('','$X_1$',18,'LaTex')
subplot(5,1,2)
plot(time0, percentchange(JCs_X2),'linewidth',2,'color',col2)
PlotBoi2('','$X_2$',18,'LaTex')
subplot(5,1,3)
plot(time0, percentchange(JCs_X3),'linewidth',2,'color',col3)
PlotBoi2('','$X_3$',18,'LaTex')
subplot(5,1,4)
plot(time0, percentchange(JCs_X4),'linewidth',2,'color',col4)
PlotBoi2('','$X_4$',18,'LaTex')
subplot(5,1,5)
plot(time0, percentchange(JCs_X5),'linewidth',2,'color',col5)
PlotBoi2('','$X_5$',18,'LaTex')
end % run_p1 == 1
...
plot3(L123(1,1),L123(1,2),L123(1,3),'^','markeredgecolor',colors.std.black,'markerfacecolor',colors.std.ltgrn)
plot3(L123(2,1),L123(2,2),L123(2,3),'^','markeredgecolor',colors.std.black,'markerfacecolor',colors.std.ltgrn)
...
% ------------------------------------
figure; hold all
plot_aeiwt(time0_unstable,aeiwt_X1_L1_unstable,'L1, Unstable Manifold')

figure; hold all
plot_aeiwt(time0_stable,aeiwt_X1_L1_stable, 'L1, Stable Manifold')

figure; hold all
plot_aeiwt(time0_unstable,aeiwt_X1_L2_unstable, 'L2, Untable Manifold')

figure; hold all
plot_aeiwt(time0_stable,aeiwt_X1_L2_stable, 'L2, Stable Manifold')

figure; hold all
plot_aeiwt(time02,aeiwt_X_L4_unstable, 'L4, Unstable Manifold')

figure; hold all
plot_aeiwt(time02,aeiwt_X_L4_stable, 'L4, Stable Manifold')

figure; hold all
plot_aeiwt(time02,aeiwt_X_L5_unstable, 'L5, Unstable Manifold')

figure; hold all
plot_aeiwt(time02,aeiwt_X_L5_stable, 'L5, Stable Manifold')
