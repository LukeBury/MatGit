...
recalculateStationParameters = 1;
...
%             R_bar = (blkdiag(Rs_SRIF(1:6,1:6,1)./10000, Rs_SRIF(7:16,7:16,k-1)) * inv(reshape(refStatesSTMs(k,17:end),16,16)));
            R_bar = (blkdiag(Rs_SRIF(1:6,1:6,1)./10000, Rs_SRIF(7:16,7:16,k-1)) * inv(stm));
            covExplosion = 1;
        else
...
lw = 1.5;
figure
subplot(3,2,1); hold all; ylim([-10 10])
...
figure
subplot(5,2,1); hold all; ylim([-10e-3 10e-3]); xlim([0 250])
...
PlotPreFitResiduals_old(Times(1:mEnd), yks_SRIF(:,1:mEnd), pError, dpError, 16) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Not full time

%%% Plotting Post-Fit Residuals
PlotPostFitResiduals_old(Times(1:mEnd), eks_SRIF(:,1:mEnd), pError, dpError, 16) %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Not full time
...
figure(22); legend('50','100','150','200','247')
figure(33); legend('Earth','50','100','150','200','247')
